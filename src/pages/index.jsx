      ...
      <main className="main-content">
        <section className="recent-notifications">
          ...
          <ul className="notification-list">
            <li>
              <p className="notification-text">[알림] 운영자 확인이 필요한 근태 정보가 있습니다. 근태관리에서 확인하세요.</p>
            ...
            <li>
              <p className="notification-text">[알림] 부(부)서장 확인이 필요한 근태 정보가 있습니다. 근태관리에서 확인하세요.</p>
              <p className="notification-meta">
                <span className="notification-time">11-18 08:34</span> | 
                <span className="notification-author">김상후 대표이사</span>
              </p>
            ...
            <li>
              <p className="notification-text">[결재 도착][의견 포함] '김지연 부장'이(가) 작성한 '회계(입금,출금,대체)품의서'이(가) 도착했습니다.</p>
              <p className="notification-meta">
