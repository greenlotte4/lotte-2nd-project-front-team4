...
import Sidebar from '@/components/common/Slidbar';
    ...
    return (
        <html lang="ko">
            <head>
                ...
                <link href="../article/resources/images/favicon/DO_favicon.ico" rel="shortcut icon" />
                <link
                    rel="preload"
                    ...
                    type="font/woff2"
                />
                <link rel="stylesheet" href="../style/board/fonts/notosans.css" media="all" />
                <link rel="stylesheet" href="../style/board//master_style.css" media="all" />
                <link rel="stylesheet" href="../style/board//go_style.css" media="all" />
                <link rel="stylesheet" href="../style/board//go_app_style2.css" media="all" />
                <link rel="stylesheet" href="../style/board//go_app_style3.css" media="all" />
                <link rel="stylesheet" href="../style/board/doc_editor.css" media="all" />
                <link rel="stylesheet" href="../style/board/go_home_dashboard.css" media="all" />
                <link rel="stylesheet" href="../style/board/go_print.css" media="print" />
                <link rel="stylesheet" href="../style/board/go_color_default.css" media="all" />
            </head>
            <body id="main" data-role="main" data-app-name="board" className="go_skin_default go_skin_advanced mini">
                <div className="go_wrap">
                    <header className="go_header go_header_2row go_header_advanced">
                        <h1 className="logo" id="advanced_logo">
                            <a href="/app/home">
                                <img className="logo" src="/resources/images/logo_do_advanced.png" alt="로고" />
                            </a>
                        </h1>
